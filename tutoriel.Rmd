...
Par défaut, la fonction `summary()` dans `brms` rapporte la moyenne de la distribution postérieure avec les intervales de compatibilité inférieurs et supérieurs à 95%. (ceci a été modifié)
...
tab1 <- conditional_effects(
  ...
  #prob = 0.89, robust = TRUE,
  spaghetti = TRUE, ndraws = 1000,
  mean = FALSE
)
spag <- attr(tab1$Zmedia_temperature_mean, "spaghetti")
```
